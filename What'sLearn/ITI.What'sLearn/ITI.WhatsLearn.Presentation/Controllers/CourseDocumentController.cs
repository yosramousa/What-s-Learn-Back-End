...
namespace ITI.WhatsLearn.Presentation.Controllers
{
    public class CourseDocumentController : ApiController
    {
        ...
        [HttpGet]
        public ResultViewModel<IEnumerable<CourseDocumentEditViewModel>> GetList(int pageIndex, int pageSize = 20)
        {
            ResultViewModel<IEnumerable<CourseDocumentEditViewModel>> result
               = new ResultViewModel<IEnumerable<CourseDocumentEditViewModel>>();
        ...
        [HttpGet]
        public ResultViewModel<CourseDocumentEditViewModel> Remove(int id)
        {
            ResultViewModel<CourseDocumentEditViewModel> result
             = new ResultViewModel<CourseDocumentEditViewModel>();
